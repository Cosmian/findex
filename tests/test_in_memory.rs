...
#[actix_rt::test]
async fn test_findex() -> Result<(), Error<cosmian_findex_in_memory::Error>> {
...
#[actix_rt::test]
async fn test_first_names() -> Result<(), Error<cosmian_findex_in_memory::Error>> {
...
async fn test_graph_compacting() {
    ...
    println!(
        ...
        <FindexInMemory<UID_LENGTH> as FindexCallbacks<
            cosmian_findex_in_memory::Error,
            UID_LENGTH,
