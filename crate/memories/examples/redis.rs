//! This example show-cases the use of Findex to securely store a hash-map with redis.
...
use cosmian_findex_memories::{
    RedisMemory,
    reexport::cosmian_findex::{ADDRESS_LENGTH, Address, Findex, IndexADT, MemoryEncryptionLayer},
};
